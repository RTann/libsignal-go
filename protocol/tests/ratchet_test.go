...
func TestBobSession(t *testing.T) {
	...
	require.NoError(t, err)
	bobIdentityKeyPair := identity.KeyPair{
		PrivateKey:  bobIdentityKeyPrivate,
		IdentityKey: bobIdentityKeyPublic,
	}
...
func TestAliceSession(t *testing.T) {
	...
	require.NoError(t, err)
	aliceIdentityKeyPair := identity.KeyPair{
		PrivateKey:  aliceIdentityKeyPrivate,
		IdentityKey: aliceIdentityKeyPublic,
	}
